    ...
    <>
      <div className="registerform">
        ...
        <div className="regrh">
            ...
            <div id="field8">
            <label>
              <input placeholder=" " type="password" value={password} required onChange={passwordChange} />
              <span>Password</span>
            ...
            <div id="field9">
            <label>
              <input placeholder=" " type="password" value={cpassword} required onChange={cPasswordChange} />
